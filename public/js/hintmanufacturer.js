...
let arrManufacturer = ['ABA', 'Abro', 'ABS', 'ABT', 'ACDelco', 'Achim', 'ACHR', 'Activeavto', 'ADI', 'ADL',
   ...
   'AUTOBACS', 'AUTOBLADE', 'AUTOCRAFT', 'Autofamily', 'Autoklacson', 'AUTOLITE', 'AUTIMANN', 'Automotor France', 'AUTOPLUS',
   'AUTOWELT', 'AVA', 'Avantech', 'Avtodriver', 'Axut', 'AYD', 'Ayfar', 'Aywiparts', 'Aztec', 'Adriauto', 'Airline', 'Alfa Car', 'Alhutech', 'Alisson', 'Alon', 'Andtech', 'Arnott', 'ASMETAL', 'Aspoeck', 'Au-lite', 'Auradia', 'Autlog', 'Autoclover', 'Autom', 'Autotechteile', 'Autostandart', 'Aydinsan',
   ...
   'EXIDE', 'EYQUEM', 'EKOFIL', 'EMMERRE', 'ERMAX', 'ERREVI', 'EUROCLUTCH', 'EUROPART', 'EXIT', 'EXOVO', 'FACET',
   ...
   'SISMAK', 'SIVENTO', 'SKF', 'SKV', 'SLP', 'SNG', 'SNR', 'SOGEFI', 'SOLIDO', 'SOREA', 'SPARTECH', 
